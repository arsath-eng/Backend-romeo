...
describe('NewPerformanceController (e2e)', () => {
  let app: INestApplication;
  const newPerformanceTaskDto = {
    id: '',
    employeeId: '',
    task: '',
    description: '',
  ...
  const newPerformanceCommentDto = {
    id: '',
    taskId: '',
    employeeId: '',
    senderId: '',
  ...
  const mockNewPerformanceComment = {
    findOne: jest.fn().mockResolvedValue(newPerformanceCommentDto),
    find: jest.fn().mockResolvedValue([newPerformanceCommentDto]),
    create: jest.fn().mockResolvedValue({}),
    save: jest.fn().mockResolvedValue(newPerformanceCommentDto),
    findOneOrFail: jest.fn().mockResolvedValue(newPerformanceCommentDto),
    remove: jest.fn().mockResolvedValue({}),
  };
  const mockAuthGuard = {};
  ...
  beforeAll(async () => {
    const moduleFixture: TestingModule = await Test.createTestingModule({
      ...
      .useValue(mockNewPerformanceComment)
  ...
  it(`/new-performance/task/:employeeId (GET)`, () => {
  ...
  it(`/:companyId/new-performance/task (POST)`, () => {
    return request(app.getHttpServer())
      .post('/:companyId/new-performance/task')
      .send(newPerformanceTaskDto)
      .expect(200)
      .expect({ statusCode: 200, description: 'success' });
  });
  it(`/:companyId/new-performance/tasks-list (POST)`, () => {
    return request(app.getHttpServer())
  ...
  it(`/new-performance/task/:id (PUT)`, () => {
    return request(app.getHttpServer())
  ...
  it(`/new-performance/task/:id (DELETE)`, () => {
    return request(app.getHttpServer())
      .delete('/new-performance/task/:id')
      .expect(200)
      .expect({ statusCode: 200, description: 'success' });
  });
  it(`/new-performance/task/comments/:taskId (GET)`, () => {
    return request(app.getHttpServer())
  ...
  it(`/:companyId/new-performance/task/comments (POST)`, () => {
    return request(app.getHttpServer())
      .post('/:companyId/new-performance/task/comments')
      .send(newPerformanceCommentDto)
      .expect(200)
      .expect({ statusCode: 200, description: 'success' });
  });
  it(`/new-performance/task-all/comments/:employeeId (GET)`, () => {
    return request(app.getHttpServer())
  ...
  it(`/new-performance/task/comments/:id (PUT)`, () => {
    return request(app.getHttpServer())
  ...
  it(`/new-performance/task/comments/:id (DELETE)`, () => {
    return request(app.getHttpServer())
